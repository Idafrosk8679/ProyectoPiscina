...
/* layout.html.twig */
class __TwigTemplate_5f8b46fbdd518e3017f892bc8d1d3827b278cdcfe234ce4dd2f359e8a4b4bfe2 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<a class=\"nav-link text-white text-uppercase font-weight-bold ";
        // line 23
        if (0 === twig_compare((isset($context["currentPath"]) || array_key_exists("currentPath", $context) ? $context["currentPath"] : (function () { throw new RuntimeError('Variable "currentPath" does not exist.', 23, $this->source); })()), "equipo")) {
            echo " active";
        }
        echo "\"
\t\t\t\t\t\thref=\"";
        // line 24
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("equipo");
        echo "\">Equipo</a>
\t\t\t\t</li>
\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t<a class=\"nav-link text-white text-uppercase font-weight-bold ";
        // line 27
        if (0 === twig_compare((isset($context["currentPath"]) || array_key_exists("currentPath", $context) ? $context["currentPath"] : (function () { throw new RuntimeError('Variable "currentPath" does not exist.', 27, $this->source); })()), "eventos")) {
            echo " active";
        }
        echo "\"
\t\t\t\t\t\thref=\"";
...
";
    ...
    {
        return array (  202 => 37,  139 => 38,  137 => 37,  125 => 28,  119 => 27,  113 => 24,  107 => 23,  101 => 20,  95 => 19,  92 => 18,  90 => 17,  77 => 7,  73 => 6,  69 => 4,  59 => 3,  36 => 1,);
    }
...
<header class=\"header\">
\t<nav class=\"navbar navbar-expand-md nav nav-justified nav-pills nav-tabs fixed-top\">
\t\t<a class=\"navbar-brand pl-lg-5 pl-md-4 pl-sm-3 mr-lg-3 mr-md-2 mr-sm-0\" href=\"{{ path('eventos') }}\">
