...
class EasyWeeklyCalClass {
    ...
    function EasyWeeklyCalClass ($dia, $mes, $ano) {
        ...
        $this->mes = $mes;
        $this->ano = $ano;
        $this->date = $this->showDate (0, 0, 0, $mes, $dia, $ano);
    }
    ...
    function previousMonth ($dia, $mes, $ano){
        $mes = $mes-1;
        $mes= $this->showDate (0, 0, 0, $mes, $dia, $ano);
        return $mes;
    }
    ...
    function numberOfWeek ($dia, $mes, $ano) {
        $firstDay = $this->showDate (0, 0, 0, $mes, 1, $ano);
    ...
    function WeekTable ($diaMes, $diaSemana, $numDiasMes, $nombreMes, $dia, $mes, $ano) {
        ...
        $WeekNumber = $this->showDate (0, 0, 0, $mes, 1, $ano);    
...
<td><b>".$i.":00</b></td>";
	...
	function buttonsWeek ($dia, $mes, $ano, $numDiasMes) {
		$thisMonth= $this->showDate (0, 0, 0, $mes, $dia, $ano);
		$thisMontOne = $this->showDate (0, 0, 0, $mes, 1, $ano);
	    $previousMonth = $this->previousMonth ($dia, $mes, $ano);
...
<a href='".$_SERVER['PHP_SELF']."?dia=".$ant."&mes=".$mesAnt."&ano=".$anoAnt."'>&laquo; previous week</a> |

<a href='".$_SERVER['PHP_SELF']."?dia=".$post."&mes=".$mesPost."&ano=".$anoPost."'>next week &raquo;</a>
</p>";
...
<a href='".$_SERVER['PHP_SELF']."?dia=".$ant."&mes=".$mesAnt."&ano=".$anoAnt."'>&laquo; previous</a> |

<a href='".$_SERVER['PHP_SELF']."?dia=".$post."&mes=".$mesPost."&ano=".$anoPost."'>next &raquo;</a>
</p>";
